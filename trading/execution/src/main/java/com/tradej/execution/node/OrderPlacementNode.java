...
public final class OrderPlacementNode extends BasePipelineNode {
 ...
 private final SpanFactory.Supplier spanFactory;
 ...
 public OrderPlacementNode(
  ...
  this(orderManagementService, runtimeModeHolder, circuitBreaker, identityRegistry, SpanFactory.supplier());
 }
 ...
 public OrderPlacementNode(
  ...
  TradingCircuitBreaker circuitBreaker,
  OrderIdentityRegistry identityRegistry,
  SpanFactory.Supplier spanFactorySupplier
 ) {
  this.orderManagementService = orderManagementService;
  this.runtimeModeHolder = runtimeModeHolder;
  this.circuitBreaker = circuitBreaker;
  this.identityRegistry = identityRegistry;
  this.spanFactory = spanFactorySupplier;
 }
 ...
 protected void processEvent(DomainEvent event) {
  ...
  try (SpanFactory.Span span = spanFactory.start()) {
   span.setAttribute("order.placement", true);
   span.setAttribute("signal.id", pending.signalId());
