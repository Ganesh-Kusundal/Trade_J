...
@Tag("unit")
class SwingHighLowProviderTest {
    ...
    void metadataIsStable() {
        SwingHighLowProvider p = new SwingHighLowProvider();
        assertEquals("swing-high-low", p.name());
        assertEquals("Swing High / Low", p.displayName());
