 ...
 * <p>Inner classes:
 * <ul>
 *   <li>{@link DhanAdapterConfig} — Dhan broker adapter (conditional on broker-type=dhan|gateway)</li>
 *   <li>{@link IciciAdapterConfig} — ICICI broker adapter (conditional on broker-type=icici|gateway)</li>
 * </ul>
 * <p>Upstox broker config remains in {@link UpstoxBrokerConfiguration} due to package-private class dependencies.
 */
@Configuration
public class BrokerConfiguration {
    ...
    static class DhanAdapterConfig {
