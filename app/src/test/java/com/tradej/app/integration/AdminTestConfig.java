 ...
 * <p>
 * Loads only the controller and rate-limit filter — all other dependencies are
 * mocked via {@link org.springframework.test.context.bean.override.mockito.MockitoBean}
 * in the test classes that extend {@link AdminTestBase}.
 */
@SpringBootConfiguration
@EnableAutoConfiguration
@Import({AdminController.class, RateLimitFilter.class})
